...
public class DoctorLogin extends JFrame {
    ...
    private void initializeUI() {
        setTitle("Doctor Login - City Hospital");
        setSize(500, 400);
    ...
    private void handleLogin() {
        ...
        try {
            ...
            if (user != null && user.getRole().equals("doctor")) {
                Doctor doctor = DatabaseManager.getDoctorByUserId(user.getUserId());
                if (doctor != null) {
                    new DoctorDashboard(doctor.getId(), doctor.getFullName()).setVisible(true);
                    dispose();
                } else {
